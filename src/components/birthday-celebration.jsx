              ...
              >
                <div className="text-center">
                  <p className="text-purple-700 mb-2">
                    Today the world shines a little brighter, celebrating the
                    light you bring wherever you go. Each smile, each gentle
                    gesture, leaves traces of magic in the hearts around you.
                  </p>
                  <p className="text-pink-600 font-medium">
                    May every dream whispered to the stars find its way home,
                    wrapped in wonder and warmth. Let this day be a canvas
                    painted with joy, laughter, and moments that linger like
                    stardust.
                  </p>
                  <div className="flex justify-center">
                    <motion.div
      ...
      >
        <div className="text-center">
          <p className="text-lg text-purple-700 mb-4">
            Soar high, free and radiant, like a butterfly exploring endless
            skies, carrying hope, beauty, and light with every beat of your
            wings. 🌍✨
          </p>
          <div className="flex justify-center items-center gap-2">
            <p className="text-pink-600 font-medium">
              Wishing you a world full of love, wonder, and the sweetest moments
              💖
            </p>
          </div>
        </div>
